...
class Logger:
    ...
    USAGE:
            Logger(name='ExpiryService')
    """
    __instance = None

    def __init__(self, name='ExpiryService', level='info', log_folder='/var/log/', log_max_bytes=10000000, backup=5):
    ...
    def __create_log_folder(self, log_folder):
        """creates log folder in '/var/log/ExpiryService'
